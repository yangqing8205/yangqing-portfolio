...
function Work() {
  ...
  return <div className="panel-content work-panel">
    ...
    </div> : <a className="essayflow-showcase" key="essay" href="https://essayflow-yangqing.vercel.app/" target="_blank" rel="noreferrer" aria-label="打开 EssayFlow 在线体验">
    ...
    {project.style === "essay" && (
      <div className="project-actions">
        <a className="project-case-link" href="https://essayflow-yangqing.vercel.app/" target="_blank" rel="noreferrer">VIEW LIVE EXPERIENCE →</a>
